...
void m_ell_fase1_ui(unsigned long k[], int size, const m_ellc *e, m_ellp *r, const m_ellp *p, m_ellp_temp *p_temp, mpz_temp *temp)
{
	m_ellp_set(r, p);
	int i;
	for (i = 0 ; i < size; i++)
...
void m_ell_fase2(mpz_t g, unsigned long b1, unsigned long b2, const mpz_t n, const mpz_t e_C2, const m_ellp *p, const m_ellp_rep rep, 
