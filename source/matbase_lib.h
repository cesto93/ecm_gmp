...
void mpz_temp_init2(mpz_temp *temp, unsigned int lenght, unsigned long int size);
...
void mpz_rep_init2(mpz_rep *rep, unsigned long int lenght, unsigned long int size);
