...
static inline void mm_ell_addh_l(mp_limb_t *rx_l, mp_limb_t *rz_l, const mp_limb_t *px_l, size_t px_s, const mp_limb_t *pz_l, size_t pz_s,
									const mp_limb_t *qx_l, size_t qx_s, const mp_limb_t *qz_l, size_t qz_s, 
									const mp_limb_t *dx_l, size_t dx_s, const mp_limb_t *dz_l, size_t dz_s,
									const mform_data *mdata, mp_limb_t *t1_l, mp_limb_t *t2_l, mp_limb_t *t3_l, mp_limb_t *tmul_l);
									
static inline void mm_ell_duph_l(const mp_limb_t *e_C2_l, size_t e_C2_s, mp_limb_t *rx_l, mp_limb_t *rz_l, 
									const mp_limb_t  *px_l, size_t px_s, const mp_limb_t  *pz_l, size_t pz_s,
									const mform_data *mdata, mp_limb_t *t1_l, mp_limb_t *t2_l, mp_limb_t *t3_l, mp_limb_t *tmul_l);

static inline void mm_ell_addh_l_n(mp_limb_t *rx_l, mp_limb_t *rz_l, const mp_limb_t *px_l, const mp_limb_t *pz_l,
									const mp_limb_t *qx_l, const mp_limb_t *qz_l, 
									const mp_limb_t *dx_l, const mp_limb_t *dz_l,
									const mform_data *mdata, mp_limb_t *t1_l, mp_limb_t *t2_l, mp_limb_t *t3_l, mp_limb_t *tmul_l);
									
static inline void mm_ell_duph_l_n(const mp_limb_t *e_C2_l, mp_limb_t *rx_l, mp_limb_t *rz_l, 
									const mp_limb_t  *px_l, const mp_limb_t  *pz_l,
									const mform_data *mdata, mp_limb_t *t1_l, mp_limb_t *t2_l, mp_limb_t *t3_l, mp_limb_t *tmul_l);									

static void mm_ell_mul_ui(unsigned long k, const mpz_t e_C2, m_ellp *r, const m_ellp *p, const mform_data *mdata, 
...
//USED ONCE FOR ITER
void mm_ell_mul(const mpz_t k, mpz_t e_C2, m_ellp *r, m_ellp *p, const mform_data *mdata, m_ellp_temp *p_temp, 
						mpz_temp *temp)
{	
	m_ellp *u, *t;
	mpz_t *t1, *t2, *t3, *tmul;
...
void mm_ell_fase2(mpz_t g, const unsigned long b1, const unsigned long b2, const mpz_t e_C2, const m_ellp *p, m_ellp *S, mpz_t *beta, 
					const unsigned long d, const unsigned char vdiff[], const mform_data *mdata, m_ellp_temp *p_temp, mpz_temp *temp)
{
	...
	for (; b < b2; b+= max_diff)
	{
		...
		mm_ell_addh_l_n(Tx_l, Tz_l, Rx_l, Rz_l, Sx_l[d - 1], Sz_l[d - 1], Tx_l, Tz_l, 
						mdata, t1_l, t2_l, t3_l, tmul_l); // T = R + s[D]
